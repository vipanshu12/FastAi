...
import { Eraser, FileText, House, Images, LogOut, Scissors, SquarePen, Users } from 'lucide-react';
...
const navItems = [
    ...
    { to: '/ai/blog-title', label: 'Blog Titles', Icon: SquarePen }, // <-- Fixed here
    { to: '/ai/remove-background', label: 'Remove Backgound', Icon: Eraser },
...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    return (
        <div className={`w-72 min-w-72 bg-white border-r border-gray-200 flex flex-col
        ...
        ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
            ...
            <div className='my-7 w-full '>
                <img src={user.imageUrl}
                    alt="User avatar" className='w-13 rounded-full mx-auto' />
